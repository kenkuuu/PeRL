...
CKPT_ARGS=(
   --hf-checkpoint /mnt/public_02/chenyanxu/model/Qwen3-8B-Base/
   --ref-load /mnt/public_02/chenyanxu/model/Qwen3-8B-Base_torch_dist
   --load /mnt/public_02/chenyanxu/model/Qwen3-8B-Base_slime_32k_test/
   --save /mnt/public_02/chenyanxu/model/Qwen3-8B-Base_slime_32k_test/
   --save-interval 128
)

SFT_ARGS=(
   --rollout-function-path slime.rollout.sft_rollout.generate_rollout
   --prompt-data /mnt/public_02/chenyanxu/dataset/OpenThoughts3-1.2M/openthoughts3_messages/train-00000-of-00120.jsonl
   --input-key messages
   #--apply-chat-template
   --rollout-shuffle
   --num-epoch 5
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-8b-base-sft-openthoughts_test
