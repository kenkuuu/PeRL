...
CKPT_ARGS=(
   --hf-checkpoint /jpfs/chenyanxu.9/model/zhennanshen/Qwen3-8B-Base/
   --ref-load /jpfs/chenyanxu.9/model/zhennanshen/Qwen3-8B-Base_torch_dist
   --load /jpfs-5p/chenyanxu.9/model/Qwen3-8B-Base-sft-dolci-think
   --save /jpfs-5p/chenyanxu.9/model/Qwen3-8B-Base-sft-dolci-think
   --save-interval 128
)
...
WANDB_ARGS=(
   ...
   --wandb-group qwen3-8b-base-sft-dolci-think
)
