...
CKPT_ARGS=(
   ...
   --save /jpfs-5p/chenyanxu.9/model/Moonlight-16B-A3B-dolci-think
   --save-interval 128
)
...
PERF_ARGS=(
   ...
   # 显存充足，关闭 activation recomputation 以提升速度
   # 如果 OOM 可改为 selective recompute: --recompute-granularity selective
